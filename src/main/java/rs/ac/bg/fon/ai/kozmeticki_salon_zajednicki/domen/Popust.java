...
/**
 * Predstavlja popust u sistemu kozmetičkog salona. Sadrzi podatke o klijentu
 * koji je ostvario popust, usluzi na koju se popust odnosi, broj rezervacija
 * usluge i popust u procentima.
 *
...
public class Popust implements OpstiDomenskiObjekat {
    ...
    public Popust(Klijent klijent, Usluga usluga, int brojRezUsluge, int popust) {
        ...
        this.setBrojRezUsluge(brojRezUsluge);
     ...
     *
     * @param klijent Novi klijent koji je ostvario popust kao instanca klase
     * Klijent.
     ...
     *
     * @param usluga Nova usluga na koju se popust odnosi kao instanca klase
     * Usluga.
     ...
     *
     * @return Broj rezervacija za uslugu i klijenta na koje se popust odnosi
     * kao ceo broj.
     */
    ...
    /**
     * Postavlja broj rezervacija za uslugu i klijenta na koje se popust odnosi
     * na prosledjenu vrednost.
     *
     * @param brojRezUsluge Novi broj rezervacija za uslugu i klijenta na koje
     * se popust odnosi kao ceo broj.
     * @throws java.lang.IllegalArgumentException Ako novi broj rezervacija
     * usluge negativan broj.
     */
     ...
     * @throws java.lang.IllegalArgumentException Ako novi iznos popusta
     * negativan broj.
     */
    ...
    /**
     * Vraca vrednosti koje se koriste prilikom unosa podataka u tabelu Popust u
     * bazi.
     *
