 ...
 * određene usluge unutar određene godine. Stavka sadrzi podatke o statistici na
 * koju se odnosi, usluge na koju se odnosi i broja rezervacija usluge.
 *
 *
...
public class StavkaStatistike implements OpstiDomenskiObjekat {
    ...
    /**
     * Kreira novu instancu klase StavkaStatistike sa zadatom statistikom,
     * uslugom i brojem rezervacija usluge.
     *
    ...
    public StavkaStatistike(Statistika statistika, Usluga usluga, int broj) {
       this.setStatistika(statistika);
       this.setUsluga(usluga);
       this.setBrojRezUsluge(broj);
    }
     ...
     *
     * @return Statistika kojoj ova stavka pripada kao instanca klase
     * Statistika.
     */
     ...
     *
     * @param statistika Nova statistika kojoj ova stavka pripada kao instanca
     * klase Statistika.
     * @throws java.lang.NullPointerException Ako je nova statistika null.
     */
     ...
     *
     * @return Usluga na koju se odnosi stavka statistike kao instanca klase
     * Usluga.
     */
    ...
    /**
     * Postavlja uslugu na koju se odnosi stavka statistike na prosledjenu
     * vrednost.
     *
     * @param usluga Nova usluga a koju se odnosi stavka statistike kao instanca
     * klase Usluga.
    ...
    /**
     * Postavlja broj rezervacija za uslugu unutar ove stavke statistike na
    ...
    /**
     * Kreira listu stavki statistike na osnovu rezultata upita iz baze
     * podataka.
     *
     ...
     * StavkaStatistike u bazi.
     *
     * @return Vrednosti za azuriranje podataka u tabeli stavkastatistike kao
     * String.
     */
    @Override
     ...
     * StavkaStatistike u bazi.
     *
     * @return Vrednosti za unos podataka u tabelu stavkastatistike u bazi kao
     * String.
     */
    @Override
